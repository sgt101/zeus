...
public class RuleTestAgent {
   protected static void version() {
      System.err.println("ZeusAgent - RuleTestAgent version: 1.1");
      System.exit(0);
   }

   protected static void usage() {
      System.err.println("Usage: java RuleTestAgent -s <dns_file> -o <ontology_file> [-gui ViewerProg] [-e <ExternalProg>] [-r ResourceProg] [-name <AgentName>] [-debug] [-h] [-v]");
      System.exit(0);
   }
   ...
   try { 
      ...
      String name = new String ("RuleTestAgent");
      Bindings b = new Bindings("RuleTestAgent");
      ...
      for( int j = 0; j < arg.length; j++ ) {
         if ( arg[j].equals("-s") &&  ++j < arg.length )
            ...
            Core.debug = true;
            Core.setDebuggerOutputFile("RuleTestAgent.log");
         }
...
*/
         AbstractTask t;
         stream = new FileInputStream("TestRulesOne.clp");
