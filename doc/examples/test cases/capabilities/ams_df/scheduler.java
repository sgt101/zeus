...
public class scheduler {
   protected static void version() {
      System.err.println("ZeusAgent - scheduler version: 1.1");
      System.exit(0);
   }

   protected static void usage() {
      System.err.println("Usage: java scheduler -s <dns_file> -o <ontology_file> [-gui ViewerProg] [-e <ExternalProg>] [-r ResourceProg] [-name <AgentName>] [-debug] [-h] [-v]");
      System.exit(0);
   }
   ...
   try { 
      ...
      String name = new String ("scheduler");
      Bindings b = new Bindings("scheduler");
      ...
      for( int j = 0; j < arg.length; j++ ) {
         if ( arg[j].equals("-s") &&  ++j < arg.length )
            ...
            Core.debug = true;
            Core.setDebuggerOutputFile("scheduler.log");
         }
