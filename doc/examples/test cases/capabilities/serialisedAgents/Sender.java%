...
public class Sender {
   protected static void version() {
      System.err.println("ZeusAgent - Sender version: 1.1");
      System.exit(0);
   }

   protected static void usage() {
      System.err.println("Usage: java Sender -s <dns_file> -o <ontology_file> [-gui ViewerProg] [-e <ExternalProg>] [-r ResourceProg] [-name <AgentName>] [-debug] [-h] [-v]");
      System.exit(0);
   }
   ...
   try { 
      ...
      Bindings b = new Bindings("Sender");
      ...
      for( int j = 0; j < arg.length; j++ ) {
         if ( arg[j].equals("-s") &&  ++j < arg.length )
            ...
            Core.debug = true;
            Core.setDebuggerOutputFile("Sender.log");
         }
...
*/
         AbilityDbItem item;
         agent.addRelation("Receiver","peer");
