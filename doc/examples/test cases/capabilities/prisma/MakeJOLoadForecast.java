...
public class MakeJOLoadForecast extends ZeusTask {
   protected void exec() {
      /*
      ...
      */
      ...
      Fact[] _newLoadForecast;	// JOLoadForecast
      ...
      _newLoadForecast = new Fact[1];
      _newLoadForecast[0] = new Fact(Fact.FACT,expOutputArgs[0]);
      System.out.println(_newLoadForecast[0].pprint());

      /* USER CODE ENDS */
      outputArgs = new Fact[1][];
      outputArgs[0] = _newLoadForecast;
   }
}
