...
public class GAService {
   protected static void version() {
      System.err.println("ZeusAgent - GAService version: 1.1");
      System.exit(0);
   }

   protected static void usage() {
      System.err.println("Usage: java GAService -s <dns_file> -o <ontology_file> [-gui ViewerProg] [-e <ExternalProg>] [-r ResourceProg] [-name <AgentName>] [-debug] [-h] [-v]");
      System.exit(0);
   }
   ...
   try { 
      ...
      String name = new String ("GAService");
      Bindings b = new Bindings("GAService");
      ...
      for( int j = 0; j < arg.length; j++ ) {
         if ( arg[j].equals("-s") &&  ++j < arg.length )
            ...
            Core.debug = true;
            Core.setDebuggerOutputFile("GAService.log");
         }
...
*/
         AbstractTask t;
         stream = new FileInputStream("PopulationSending.clp");
