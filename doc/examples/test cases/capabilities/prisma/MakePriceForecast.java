...
public class MakePriceForecast extends ZeusTask {
   protected void exec() {
      /*
      ...
      */
      ...
      Fact[] _priceForecast;	// PriceForecast
      ...
      _priceForecast = new Fact[1];
      _priceForecast[0] = new Fact(Fact.FACT,expOutputArgs[0]);
      System.out.println(_priceForecast[0].pprint());

      /* USER CODE ENDS */
      outputArgs = new Fact[1][];
      outputArgs[0] = _priceForecast;
   }
}
