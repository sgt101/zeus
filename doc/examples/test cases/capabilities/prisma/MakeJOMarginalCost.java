...
public class MakeJOMarginalCost extends ZeusTask {
   protected void exec() {
      /*
      ...
      */
      ...
      Fact[] _var629;	// JOMarginalCostMatrix
      ...
      _var629 = new Fact[1];
      _var629[0] = new Fact(Fact.FACT,expOutputArgs[0]);
      System.out.println(_var629[0].pprint());

      /* USER CODE ENDS */
      outputArgs = new Fact[1][];
      outputArgs[0] = _var629;
   }
}
