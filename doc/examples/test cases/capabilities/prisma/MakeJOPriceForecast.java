...
public class MakeJOPriceForecast extends ZeusTask {
   protected void exec() {
      /*
      ...
      */
      ...
      Fact[] _newJOPriceForecast;	// JOPriceForecast
      ...
      _newJOPriceForecast = new Fact[1];
      _newJOPriceForecast[0] = new Fact(Fact.FACT,expOutputArgs[0]);
      System.out.println(_newJOPriceForecast[0].pprint());

      /* USER CODE ENDS */
      outputArgs = new Fact[1][];
      outputArgs[0] = _newJOPriceForecast;
   }
}
