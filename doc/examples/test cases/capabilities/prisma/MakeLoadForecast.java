...
public class MakeLoadForecast extends ZeusTask {
   protected void exec() {
      /*
      ...
      */
      ...
      Fact[] _joLoadForecast = inputArgs[0];	// JOLoadForecast
      Fact[] _var484 = inputArgs[1];	// KnownLoad

      // The Output Facts:

      Fact[] _knownLoad;	// KnownLoad
      ...
      _knownLoad = new Fact[1];
      _knownLoad[0] = new Fact(Fact.FACT,expOutputArgs[0]);
      System.out.println(_knownLoad[0].pprint());

      /* USER CODE ENDS */
      outputArgs = new Fact[1][];
      outputArgs[0] = _knownLoad;
   }
}
