...
public class MakeSupply extends ZeusTask {
   protected void exec() {
      /*
      ...
      */
      ...
      Fact[] _capacity = inputArgs[0];	// Capacity
      Fact[] _knownLoad = inputArgs[1];	// KnownLoad
      Fact[] _tradingQuantity = inputArgs[2];	// TradingQuantity
      Fact[] _marginalCost = inputArgs[3];	// MarginalCost
      Fact[] _interest = inputArgs[4];	// Interest
      Fact[] _risk = inputArgs[5];	// Risk
      Fact[] _priceForecast = inputArgs[6];	// PriceForecast

      // The Output Facts:

      Fact[] _supplyContract;	// SupplyContract
      Fact[] _newTradingQuantity;	// TradingQuantity
      ...
      _supplyContract = new Fact[1];
      _supplyContract[0] = new Fact(Fact.FACT,expOutputArgs[0]);
      System.out.println(_supplyContract[0].pprint());
      _newTradingQuantity = new Fact[1];
      _newTradingQuantity[0] = new Fact(Fact.FACT,expOutputArgs[1]);
      System.out.println(_newTradingQuantity[0].pprint());

      /* USER CODE ENDS */
      outputArgs = new Fact[2][];
      outputArgs[0] = _supplyContract;
      outputArgs[1] = _newTradingQuantity;
   }
}
