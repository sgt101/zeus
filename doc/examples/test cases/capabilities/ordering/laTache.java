...
public class laTache extends ZeusTask {
   protected void exec() {
      /*
      ...
      */
      ...
      Fact[] _var323 = inputArgs[0];	// consome
      Fact[] _var291 = inputArgs[1];	// consomeTwo

      // The Output Facts:

      Fact[] _var344;	// produit
      ...
      _var344 = new Fact[1];
      _var344[0] = new Fact(Fact.FACT,expOutputArgs[0]);
      System.out.println(_var344[0].pprint());

      /* USER CODE ENDS */
      outputArgs = new Fact[1][];
      outputArgs[0] = _var344;
   }
}
