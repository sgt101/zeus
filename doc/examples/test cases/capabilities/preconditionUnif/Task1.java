...
public class Task1 extends ZeusTask {
   protected void exec() {
      /*
      ...
      */
      ...
      Fact[] _var18 = inputArgs[0];	// FactForTesting

      // The Output Facts:

      Fact[] _var21;	// FactForTesting
      ...
      _var21 = new Fact[1];
      _var21[0] = new Fact(Fact.FACT,expOutputArgs[0]);
      System.out.println(_var21[0].pprint());
