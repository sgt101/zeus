...
*/
         ProtocolInfo info;
         info = ZeusParser.protocolInfo(db,"(:name \"zeus.actors.graphs.ContractNetInitiator\" :type Initiator :constraints ((:fact (:type ZeusFact :id var66 :modifiers 1) :type 0 :strategy \"zeus.actors.graphs.DefaultInitiatorEvaluator\")))");
         if ( info.resolve(b) )
...
*/
         AbstractTask t;
         t = ZeusParser.primitiveTask(db,"(:Primitive Task0 :time (1) :cost (0) :consumed_facts ((:type FactForTesting :id var33 :modifiers 1 :attributes ((att2 <10)(att1 >9)))) :produced_facts ((:type FactForTesting :id var38 :modifiers 1 :attributes ((att2 0)(att1 0)))))");
         if ( t.resolve(b) )
            agent.addTask(t);
/*
...
*/
         AbilityDbItem item;
         agent.addRelation("Agent1","subordinate");
