...
import java.awt.*;
/**
    SpeedFrontEnd is a simple gui that is used to display some statistics on agent 
    messaging 
    */
public class SpeedFrontEnd extends JFrame {
   ...
   private JTextField targetName = new JTextField ("");
   private JButton sendNew = new JButton("send");
   



   public SpeedFrontEnd (String name)  { 
        super (); 
        this.setTitle (name); 
    ...
    public static void main (String argv[]) { 
        SpeedFrontEnd test = new SpeedFrontEnd("test"); 
    ...
    public String getName () {
        String retval = targetName.getText();
       // targetName.setText();
        return retval;
        }
    }
