...
public class ShaggyAgent {
   protected static void version() {
      System.err.println("ShaggyAgent version: 1.0_b1");
      System.exit(0);
   }

   protected static void usage() {
      System.err.println("Usage: java ShaggyAgent -s <dns_file> -o <ontology_file> [-gui ViewerProg] [-e <ExternalProg>] [-r ResourceProg] [-debug] [-h] [-v]");
      System.exit(0);
   }
   ...
   public static void main(String[] arg) {
      ...
      for( int j = 0; j < arg.length; j++ ) {
         if ( arg[j].equals("-s") &&  ++j < arg.length )
            ...
            Core.debug = true;
            Core.setDebuggerOutputFile("ShaggyAgent.log");
         }
      ...
      try {
         ...
         agent = new ZeusAgent("ShaggyAgent",ontology_file,nameservers,1,20);
