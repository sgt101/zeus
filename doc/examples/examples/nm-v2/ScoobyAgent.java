...
public class ScoobyAgent {
   protected static void version() {
      System.err.println("ScoobyAgent version: 1.0_b1");
      System.exit(0);
   }

   protected static void usage() {
      System.err.println("Usage: java ScoobyAgent -s <dns_file> -o <ontology_file> [-gui ViewerProg] [-e <ExternalProg>] [-r ResourceProg] [-debug] [-h] [-v]");
      System.exit(0);
   }
   ...
   public static void main(String[] arg) {
      ...
      for( int j = 0; j < arg.length; j++ ) {
         if ( arg[j].equals("-s") &&  ++j < arg.length )
            ...
            Core.debug = true;
            Core.setDebuggerOutputFile("ScoobyAgent.log");
         }
      ...
      try {
         ...
         agent = new ZeusAgent("ScoobyAgent",ontology_file,nameservers,1,20);
...
*/
         AbstractTask t;
         stream = new FileInputStream("MonitorNetwork.clp");
...
*/
         ...
         if ( external != null ) {
            ...
            NE_ExternalDbInterface user_prog = (NE_ExternalDbInterface) c.newInstance();
