...
public class Task0 extends ZeusTask {
   protected void exec() {
      ...
      */
      ...
      Fact[] _var40 = inputArgs[0];	// Fact9
      Fact[] _var41 = inputArgs[1];	// Fact11

      // The Output Facts:

      Fact[] _var39;	// fortesting
      ...
      _var39 = new Fact[1];
      _var39[0] = new Fact(Fact.FACT,expOutputArgs[0]);
      System.out.println(_var39[0].pprint());
