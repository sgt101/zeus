...
/*
This stub file was automatically generated by ZeusAgentGenerator version 1.02
*/
...
public class Type3Repair extends ZeusTask {
   protected void exec() {
      /*
      ...
      */
      ...
      Fact[] _repair1 = inputArgs[0];	// Repair
      Fact[] _repair2 = inputArgs[1];	// Repair
      Fact[] _engineer = inputArgs[2];	// Engineer

      // The Output Facts:

      Fact[] _repair3;	// Repair
      ...
      _repair3 = new Fact[1];
      _repair3[0] = new Fact(Fact.FACT,expOutputArgs[0]);
      System.out.println(_repair3[0].pprint());

      /* USER CODE ENDS */
      outputArgs = new Fact[1][];
      outputArgs[0] = _repair3;
   }
}
