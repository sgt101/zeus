...
public class WorldSimulator {
   protected static void version() {
      System.err.println("ZeusAgent - WorldSimulator version: 1.02");
      System.exit(0);
   }

   protected static void usage() {
      System.err.println("Usage: java WorldSimulator -s <dns_file> -o <ontology_file> [-gui ViewerProg] [-e <ExternalProg>] [-r ResourceProg] [-debug] [-h] [-v]");
      System.exit(0);
   }
   ...
   public static void main(String[] arg) {
      ...
      Bindings b = new Bindings("WorldSimulator");
      ...
      for( int j = 0; j < arg.length; j++ ) {
         if ( arg[j].equals("-s") &&  ++j < arg.length )
            ...
            Core.debug = true;
            Core.setDebuggerOutputFile("WorldSimulator.log");
         }
      ...
      try {
         ...
         agent = new ZeusAgent("WorldSimulator",ontology_file,nameservers,1,20,false,true);
...
*/
         AbstractTask t;
         stream = new FileInputStream("FaultSimulator.clp");
