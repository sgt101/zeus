...
public class Type4Repair extends ZeusTask {
   protected void exec() {
      /*
      ...
      */
      ...
      Fact[] _engineer = inputArgs[0];	// Engineer
      Fact[] _prep = inputArgs[1];	// Repair
      ...
      _repair = new Fact[1];
      _repair[0] = new Fact(Fact.FACT,expOutputArgs[0]);
      System.out.println(_repair[0].pprint());

      /* USER CODE ENDS */
      outputArgs = new Fact[1][];
      outputArgs[0] = _repair;
   }
}
