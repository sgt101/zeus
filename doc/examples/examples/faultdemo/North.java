...
public class North {
   protected static void version() {
      System.err.println("ZeusAgent - North version: 1.02");
      System.exit(0);
   }

   protected static void usage() {
      System.err.println("Usage: java North -s <dns_file> -o <ontology_file> [-gui ViewerProg] [-e <ExternalProg>] [-r ResourceProg] [-debug] [-h] [-v]");
      System.exit(0);
   }
   ...
   public static void main(String[] arg) {
      ...
      for( int j = 0; j < arg.length; j++ ) {
         if ( arg[j].equals("-s") &&  ++j < arg.length )
            ...
            Core.debug = true;
            Core.setDebuggerOutputFile("North.log");
         }
      ...
      try {
         ...
         agent = new ZeusAgent("North",ontology_file,nameservers,2,30,true,true);
