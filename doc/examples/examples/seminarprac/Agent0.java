...
*/
         AbstractTask t;
         stream = new FileInputStream("Task1.clp");
         t = ZeusParser.reteKB(db,stream);
         stream.close();
         if ( t.resolve(b) )
            agent.addTask(t);
         t = ZeusParser.primitiveTask(db,"(:Primitive Task0 :time (1) :cost (0) :produced_facts ((:type Eest :id var28 :modifiers 1 :attributes ((name ?var29)))))");
         if ( t.resolve(b) )
            agent.addTask(t);
/*
