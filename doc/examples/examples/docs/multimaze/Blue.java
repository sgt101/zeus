...
public class Blue {
   protected static void version() {
      System.err.println("ZeusAgent - Blue version: 1.1");
      System.exit(0);
   }

   protected static void usage() {
      System.err.println("Usage: java Blue -s <dns_file> -o <ontology_file> [-gui ViewerProg] [-e <ExternalProg>] [-r ResourceProg] [-name <AgentName>] [-debug] [-h] [-v]");
      System.exit(0);
   }
   ...
   try { 
      ...
      String name = new String ("Blue");
      Bindings b = new Bindings("Blue");
      ...
      for( int j = 0; j < arg.length; j++ ) {
         if ( arg[j].equals("-s") &&  ++j < arg.length )
            ...
            Core.debug = true;
            Core.setDebuggerOutputFile("Blue.log");
         }
...
*/
         Fact f1;
         f1 = ZeusParser.fact(db,"(:type thisMove :id fact39 :modifiers 0 :attributes ((west false)(south false)(east false)(north false)(id Blue)))");
         if ( f1.resolve(b) )
            agent.addFact(f1);
