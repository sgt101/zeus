...
public class Green {
   protected static void version() {
      System.err.println("ZeusAgent - Green version: 1.1");
      System.exit(0);
   }

   protected static void usage() {
      System.err.println("Usage: java Green -s <dns_file> -o <ontology_file> [-gui ViewerProg] [-e <ExternalProg>] [-r ResourceProg] [-name <AgentName>] [-debug] [-h] [-v]");
      System.exit(0);
   }
   ...
   try { 
      ...
      String name = new String ("Green");
      Bindings b = new Bindings("Green");
      ...
      for( int j = 0; j < arg.length; j++ ) {
         if ( arg[j].equals("-s") &&  ++j < arg.length )
            ...
            Core.debug = true;
            Core.setDebuggerOutputFile("Green.log");
         }
...
*/
         Fact f1;
         f1 = ZeusParser.fact(db,"(:type thisMove :id fact39 :modifiers 0 :attributes ((west false)(south false)(east false)(north false)(id Green)))");
         if ( f1.resolve(b) )
            agent.addFact(f1);
