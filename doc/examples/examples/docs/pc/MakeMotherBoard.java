...
public String getDescription() {
	...
	serviceDescription += "<profile:webURL>\" http://"+context.whereAmI() + "/services/AbstractTaskId2\"</profile:webURL>\n";
	...
	serviceDescription += "<profile:restrictedTo rdf:resource=\"http://"+context.whereAmI()+"/ontologies/"+context.getOntologyDb().getOntologyName() +"#CPU#unit_cost#?var128\"/>\n";
	serviceDescription += "<profile:restrictedTo rdf:resource=\"http://"+context.whereAmI()+"/ontologies/"+context.getOntologyDb().getOntologyName() +"#CPU#type#?mb.type\"/>\n";
	serviceDescription += "<profile:restrictedTo rdf:resource=\"http://"+context.whereAmI()+"/ontologies/"+context.getOntologyDb().getOntologyName() +"#CPU#number#?mb.number\"/>\n";
	...
	serviceDescription += "<profile:restrictedTo rdf:resource=\"http://"+context.whereAmI()+"/ontologies/"+context.getOntologyDb().getOntologyName() +"#MotherBoard#unit_cost#?var288\"/>\n";
	serviceDescription += "<profile:restrictedTo rdf:resource=\"http://"+context.whereAmI()+"/ontologies/"+context.getOntologyDb().getOntologyName() +"#MotherBoard#type#?var290\"/>\n";
	serviceDescription += "<profile:restrictedTo rdf:resource=\"http://"+context.whereAmI()+"/ontologies/"+context.getOntologyDb().getOntologyName() +"#MotherBoard#number#?var289\"/>\n";
	serviceDescription += "</profile:ParameterDescription>\n";
	serviceDescription += "</profile:postcondition>\n";
