...
public String getDescription() {
	...
	serviceDescription += "<profile:webURL>\" http://"+context.whereAmI() + "/services/AbstractTaskId5\"</profile:webURL>\n";
	...
	serviceDescription += "<profile:restrictedTo rdf:resource=\"http://"+context.whereAmI()+"/ontologies/"+context.getOntologyDb().getOntologyName() +"#TonerCartridge#unit_cost#?var201\"/>\n";
	serviceDescription += "<profile:restrictedTo rdf:resource=\"http://"+context.whereAmI()+"/ontologies/"+context.getOntologyDb().getOntologyName() +"#TonerCartridge#number#?var202\"/>\n";
