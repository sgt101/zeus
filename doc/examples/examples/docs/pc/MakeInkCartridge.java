...
public String getDescription() {
	...
	serviceDescription += "<profile:webURL>\" http://"+context.whereAmI() + "/services/AbstractTaskId6\"</profile:webURL>\n";
	...
	serviceDescription += "<profile:restrictedTo rdf:resource=\"http://"+context.whereAmI()+"/ontologies/"+context.getOntologyDb().getOntologyName() +"#InkCartridge#unit_cost#?var198\"/>\n";
	serviceDescription += "<profile:restrictedTo rdf:resource=\"http://"+context.whereAmI()+"/ontologies/"+context.getOntologyDb().getOntologyName() +"#InkCartridge#number#?var199\"/>\n";
