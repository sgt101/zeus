...
public class MakeMotherBoard extends ZeusTask {
...
public String getDescription() {
	...
	serviceDescription += "<profile:Profile rdf:ID=\"MakeMotherBoard\">\n";
	...
	serviceDescription += "<profile:name> MakeMotherBoard</profile:name>\n";
	...
	serviceDescription += "<profile:webURL>\" http://"+context.whereAmI() + "/services/MakeMotherBoard.daml\"</profile:webURL>\n";
	...
	serviceDescription += "<profile:ParameterDescription rdf:ID=\"CPU\">\n";
	serviceDescription += "<profile:parameterName>?cpu</profile:parameterName>\n";
	serviceDescription += "<profile:type>CPU</profile:type>\n";
	serviceDescription += "<profile:range>\"http://"+context.whereAmI()+"/ontologies/"+context.getOntologyDb().getOntologyName() +"#CPU:unit_cost=?var128\"</profile:range>;
\n";
	serviceDescription += "<profile:range>\"http://"+context.whereAmI()+"/ontologies/"+context.getOntologyDb().getOntologyName() +"#CPU:type=?mb.type\"</profile:range>;
\n";
	serviceDescription += "<profile:range>\"http://"+context.whereAmI()+"/ontologies/"+context.getOntologyDb().getOntologyName() +"#CPU:number=?mb.number\"</profile:range>;
\n";
	...
	serviceDescription += "<profile:parameterName>?mb</profile:parameterName>\n";
	serviceDescription += "<profile:type>MotherBoard</profile:type>\n";
	serviceDescription += "<profile:range>\"http://"+context.whereAmI()+"/ontologies/"+context.getOntologyDb().getOntologyName() +"#MotherBoard:unit_cost=?var288\"</profile:range>;
\n";
	serviceDescription += "<profile:range>\"http://"+context.whereAmI()+"/ontologies/"+context.getOntologyDb().getOntologyName() +"#MotherBoard:type=?var290\"</profile:range>;
\n";
	serviceDescription += "<profile:range>\"http://"+context.whereAmI()+"/ontologies/"+context.getOntologyDb().getOntologyName() +"#MotherBoard:number=?var289\"</profile:range>;
\n";
	serviceDescription += "</profile:ParameterDescription>\n";
	serviceDescription += "</profile:postcondition>\n";
   ...
   protected void exec() {
      ...
      */
      ...
      Fact[] _cpu = inputArgs[0];	// CPU

      // The Output Facts:

      Fact[] _mb;	// MotherBoard
      ...
      _mb = new Fact[1];
      _mb[0] = new Fact(Fact.FACT,expOutputArgs[0]);
      System.out.println(_mb[0].pprint());
