...
public class MakeLaserPrinter extends ZeusTask {
...
public String getDescription() {
	...
	serviceDescription += "<profile:Profile rdf:ID=\"MakeLaserPrinter\">\n";
	...
	serviceDescription += "<profile:name> MakeLaserPrinter</profile:name>\n";
	...
	serviceDescription += "<profile:webURL>\" http://"+context.whereAmI() + "/services/MakeLaserPrinter.daml\"</profile:webURL>\n";
	...
	serviceDescription += "<profile:range>\"http://"+context.whereAmI()+"/ontologies/"+context.getOntologyDb().getOntologyName() +"#PrinterCase:unit_cost=?var48\"</profile:range>;
\n";
...
\n";
	...
	serviceDescription += "<profile:range>\"http://"+context.whereAmI()+"/ontologies/"+context.getOntologyDb().getOntologyName() +"#TonerCartridge:unit_cost=?var208\"</profile:range>;
\n";
	serviceDescription += "<profile:range>\"http://"+context.whereAmI()+"/ontologies/"+context.getOntologyDb().getOntologyName() +"#TonerCartridge:number=?printer.number\"</profile:range>;
\n";
	serviceDescription += "</profile:ParameterDescription>\n";
	serviceDescription += "</profile:input>\n";
	...
	serviceDescription += "<profile:range>\"http://"+context.whereAmI()+"/ontologies/"+context.getOntologyDb().getOntologyName() +"#Printer:unit_cost=?var52\"</profile:range>;
\n";
	serviceDescription += "<profile:range>\"http://"+context.whereAmI()+"/ontologies/"+context.getOntologyDb().getOntologyName() +"#Printer:type=laser\"</profile:range>;
\n";
	serviceDescription += "<profile:range>\"http://"+context.whereAmI()+"/ontologies/"+context.getOntologyDb().getOntologyName() +"#Printer:number=?var304\"</profile:range>;
\n";
	serviceDescription += "</profile:ParameterDescription>\n";
	serviceDescription += "</profile:postcondition>\n";
   ...
   protected void exec() {
      ...
      */
      ...
      Fact[] _toner = inputArgs[1];	// TonerCartridge
