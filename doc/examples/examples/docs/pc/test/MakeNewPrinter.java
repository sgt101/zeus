...
public class MakeNewPrinter extends ZeusTask {
...
public String getDescription() {
	...
	serviceDescription += "<profile:Profile rdf:ID=\"MakeNewPrinter\">\n";
	...
	serviceDescription += "<profile:name> MakeNewPrinter</profile:name>\n";
	...
	serviceDescription += "<profile:webURL>\" http://"+context.whereAmI() + "/services/MakeNewPrinter.daml\"</profile:webURL>\n";
	serviceDescription += "</profile:ServiceProvider>\n</profile:providedBy>\n";
	serviceDescription += "<profile:geographicRadius>10km</profile:geographicRadius>\n";
	...
	serviceDescription += "<profile:parameterName>?var171</profile:parameterName>\n";
	serviceDescription += "<profile:type>InkCartridge</profile:type>\n";
	serviceDescription += "<profile:range>\"http://"+context.whereAmI()+"/ontologies/"+context.getOntologyDb().getOntologyName() +"#InkCartridge:unit_cost=?var172\"</profile:range>;
\n";
	serviceDescription += "<profile:range>\"http://"+context.whereAmI()+"/ontologies/"+context.getOntologyDb().getOntologyName() +"#InkCartridge:number=?var173\"</profile:range>;
\n";
	serviceDescription += "</profile:ParameterDescription>\n";
	serviceDescription += "</profile:input>\n";
	serviceDescription += "<profile:input>\n";
	serviceDescription += "<profile:ParameterDescription rdf:ID=\"PrinterCase\">\n";
	serviceDescription += "<profile:parameterName>?var174</profile:parameterName>\n";
	serviceDescription += "<profile:type>PrinterCase</profile:type>\n";
	serviceDescription += "<profile:range>\"http://"+context.whereAmI()+"/ontologies/"+context.getOntologyDb().getOntologyName() +"#PrinterCase:unit_cost=?var175\"</profile:range>;
\n";
	serviceDescription += "<profile:range>\"http://"+context.whereAmI()+"/ontologies/"+context.getOntologyDb().getOntologyName() +"#PrinterCase:type=?var176\"</profile:range>;
\n";
	serviceDescription += "<profile:range>\"http://"+context.whereAmI()+"/ontologies/"+context.getOntologyDb().getOntologyName() +"#PrinterCase:number=?var177\"</profile:range>;
\n";
	serviceDescription += "</profile:ParameterDescription>\n";
	serviceDescription += "</profile:input>\n";
	serviceDescription += "<profile:postcondition>\n";
	serviceDescription += "<profile:ParameterDescription rdf:ID=\"Printer\">\n";
	serviceDescription += "<profile:parameterName>?var178</profile:parameterName>\n";
	serviceDescription += "<profile:type>Printer</profile:type>\n";
	serviceDescription += "<profile:range>\"http://"+context.whereAmI()+"/ontologies/"+context.getOntologyDb().getOntologyName() +"#Printer:unit_cost=?var179\"</profile:range>;
\n";
	serviceDescription += "<profile:range>\"http://"+context.whereAmI()+"/ontologies/"+context.getOntologyDb().getOntologyName() +"#Printer:type=?var180\"</profile:range>;
\n";
	serviceDescription += "<profile:range>\"http://"+context.whereAmI()+"/ontologies/"+context.getOntologyDb().getOntologyName() +"#Printer:number=?var181\"</profile:range>;
\n";
	serviceDescription += "</profile:ParameterDescription>\n";
	serviceDescription += "</profile:postcondition>\n";
   ...
   protected void exec() {
      ...
      */
      ...
      Fact[] _var171 = inputArgs[0];	// InkCartridge
      Fact[] _var174 = inputArgs[1];	// PrinterCase

      // The Output Facts:

      Fact[] _var178;	// Printer
      ...
      _var178 = new Fact[1];
      _var178[0] = new Fact(Fact.FACT,expOutputArgs[0]);
      System.out.println(_var178[0].pprint());

      /* USER CODE ENDS */
      outputArgs = new Fact[1][];
      outputArgs[0] = _var178;
   }
}
