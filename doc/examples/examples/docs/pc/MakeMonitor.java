...
public String getDescription() {
	...
	serviceDescription += "<profile:webURL>\" http://"+context.whereAmI() + "/services/AbstractTaskId1\"</profile:webURL>\n";
	...
	serviceDescription += "<profile:restrictedTo rdf:resource=\"http://"+context.whereAmI()+"/ontologies/"+context.getOntologyDb().getOntologyName() +"#CRT#unit_cost#?var64\"/>\n";
	serviceDescription += "<profile:restrictedTo rdf:resource=\"http://"+context.whereAmI()+"/ontologies/"+context.getOntologyDb().getOntologyName() +"#CRT#number#?monitor.number\"/>\n";
	...
	serviceDescription += "<profile:restrictedTo rdf:resource=\"http://"+context.whereAmI()+"/ontologies/"+context.getOntologyDb().getOntologyName() +"#GFXadapter#unit_cost#?var67\"/>\n";
	serviceDescription += "<profile:restrictedTo rdf:resource=\"http://"+context.whereAmI()+"/ontologies/"+context.getOntologyDb().getOntologyName() +"#GFXadapter#type#?monitor.type\"/>\n";
	serviceDescription += "<profile:restrictedTo rdf:resource=\"http://"+context.whereAmI()+"/ontologies/"+context.getOntologyDb().getOntologyName() +"#GFXadapter#number#?monitor.number\"/>\n";
	serviceDescription += "</profile:ParameterDescription>\n";
	serviceDescription += "</profile:input>\n";
	...
	serviceDescription += "<profile:restrictedTo rdf:resource=\"http://"+context.whereAmI()+"/ontologies/"+context.getOntologyDb().getOntologyName() +"#Monitor#unit_cost#?var71\"/>\n";
	serviceDescription += "<profile:restrictedTo rdf:resource=\"http://"+context.whereAmI()+"/ontologies/"+context.getOntologyDb().getOntologyName() +"#Monitor#type#?var316\"/>\n";
	serviceDescription += "<profile:restrictedTo rdf:resource=\"http://"+context.whereAmI()+"/ontologies/"+context.getOntologyDb().getOntologyName() +"#Monitor#number#?var315\"/>\n";
	serviceDescription += "</profile:ParameterDescription>\n";
	serviceDescription += "</profile:postcondition>\n";
