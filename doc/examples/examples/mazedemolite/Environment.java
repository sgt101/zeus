...
public class Environment {
   protected static void version() {
      System.err.println("ZeusAgent - Environment version: 1.04");
      System.exit(0);
   }

   protected static void usage() {
      System.err.println("Usage: java Environment -s <dns_file> -o <ontology_file> [-gui ViewerProg] [-e <ExternalProg>] [-r ResourceProg] [-name <AgentName>] [-debug] [-h] [-v]");
      System.exit(0);
   }
   ...
   try { 
      ...
      String name = new String ("Environment");
      ...
      for( int j = 0; j < arg.length; j++ ) {
         if ( arg[j].equals("-s") &&  ++j < arg.length )
            ...
            Core.debug = true;
            Core.setDebuggerOutputFile("Environment.log");
         }
...
*/
         AbstractTask t;
         stream = new FileInputStream("respondMove.clp");
...
*/
         Fact f1;
         f1 = ZeusParser.fact(db,"(:type agentRegistered :id fact195 :modifiers 0 :attributes ((name Environment)))");
         if ( f1.resolve(b) )
            agent.addFact(f1);
