...
public class FAA {
   protected static void version() {
      System.err.println("FAA version: 1.0_b1");
      System.exit(0);
   }

   protected static void usage() {
      System.err.println("Usage: java FAA -s <dns_file> -o <ontology_file> [-gui ViewerProg] [-e <ExternalProg>] [-r ResourceProg] [-debug] [-h] [-v]");
      System.exit(0);
   }
   ...
   public static void main(String[] arg) {
      ...
      for( int j = 0; j < arg.length; j++ ) {
         if ( arg[j].equals("-s") &&  ++j < arg.length )
            ...
            Core.debug = true;
            Core.setDebuggerOutputFile("FAA.log");
         }
      ...
      try {
         ...
         agent = new ZeusAgent("FAA",ontology_file,nameservers,1,20);
...
*/
         ...
         agent.addRelation("FTM","peer");

         agent.addRelation("VCW","peer");
...
*/
         AbstractTask t;
         stream = new FileInputStream("FAA_path_manager.clp");
