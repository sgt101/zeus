...
public class MakeMonitor extends ZeusTask {
...
public String getDescription() {
	...
	serviceDescription += "<profile:Profile rdf:ID=\"MakeMonitor\">\n";
	...
	serviceDescription += "<profile:name> MakeMonitor</profile:name>\n";
	...
	serviceDescription += "<profile:webURL>\" http://"+context.whereAmI() + "/services/MakeMonitor.daml\"</profile:webURL>\n";
	...
	serviceDescription += "<profile:ParameterDescription rdf:ID=\"CRT\">\n";
	serviceDescription += "<profile:parameterName>?crt</profile:parameterName>\n";
	serviceDescription += "<profile:type>CRT</profile:type>\n";
	serviceDescription += "<profile:range>\"http://"+context.whereAmI()+"/ontologies/"+context.getOntologyDb().getOntologyName() +"#CRT:unit_cost=?var64\"</profile:range>;
\n";
	serviceDescription += "<profile:range>\"http://"+context.whereAmI()+"/ontologies/"+context.getOntologyDb().getOntologyName() +"#CRT:number=?monitor.number\"</profile:range>;
\n";
	serviceDescription += "</profile:ParameterDescription>\n";
	serviceDescription += "</profile:input>\n";
	serviceDescription += "<profile:input>\n";
	serviceDescription += "<profile:ParameterDescription rdf:ID=\"GFXadapter\">\n";
	serviceDescription += "<profile:parameterName>?card</profile:parameterName>\n";
	serviceDescription += "<profile:type>GFXadapter</profile:type>\n";
	serviceDescription += "<profile:range>\"http://"+context.whereAmI()+"/ontologies/"+context.getOntologyDb().getOntologyName() +"#GFXadapter:unit_cost=?var67\"</profile:range>;
\n";
	serviceDescription += "<profile:range>\"http://"+context.whereAmI()+"/ontologies/"+context.getOntologyDb().getOntologyName() +"#GFXadapter:type=?monitor.type\"</profile:range>;
\n";
	serviceDescription += "<profile:range>\"http://"+context.whereAmI()+"/ontologies/"+context.getOntologyDb().getOntologyName() +"#GFXadapter:number=?monitor.number\"</profile:range>;
\n";
	serviceDescription += "</profile:ParameterDescription>\n";
	serviceDescription += "</profile:input>\n";
	...
	serviceDescription += "<profile:range>\"http://"+context.whereAmI()+"/ontologies/"+context.getOntologyDb().getOntologyName() +"#Monitor:unit_cost=?var71\"</profile:range>;
\n";
	serviceDescription += "<profile:range>\"http://"+context.whereAmI()+"/ontologies/"+context.getOntologyDb().getOntologyName() +"#Monitor:type=?var316\"</profile:range>;
\n";
	serviceDescription += "<profile:range>\"http://"+context.whereAmI()+"/ontologies/"+context.getOntologyDb().getOntologyName() +"#Monitor:number=?var315\"</profile:range>;
\n";
	serviceDescription += "</profile:ParameterDescription>\n";
	serviceDescription += "</profile:postcondition>\n";
   ...
   protected void exec() {
      ...
      */
      ...
      Fact[] _crt = inputArgs[0];	// CRT
      Fact[] _card = inputArgs[1];	// GFXadapter

      // The Output Facts:

      Fact[] _monitor;	// Monitor
      ...
      _monitor = new Fact[1];
      _monitor[0] = new Fact(Fact.FACT,expOutputArgs[0]);
      System.out.println(_monitor[0].pprint());

      /* USER CODE ENDS */
      outputArgs = new Fact[1][];
      outputArgs[0] = _monitor;
   }
}
