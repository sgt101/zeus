...
public class MotherBoardMaker {
   protected static void version() {
      System.err.println("ZeusAgent - MotherBoardMaker version: 1.2.2");
      System.exit(0);
   }

   protected static void usage() {
      System.err.println("Usage: java MotherBoardMaker -s <dns_file> -o <ontology_file> [-gui ViewerProg] [-e <ExternalProg>] [-r ResourceProg] [-name <AgentName>] [-debug] [-h] [-v]");
      System.exit(0);
   }
   ...
   try { 
      ...
      String name = new String ("MotherBoardMaker");
      Bindings b = new Bindings("MotherBoardMaker");
      ...
      for( int j = 0; j < arg.length; j++ ) {
         if ( arg[j].equals("-s") &&  ++j < arg.length )
            ...
            Core.debug = true;
            Core.setDebuggerOutputFile("MotherBoardMaker.log");
         }
