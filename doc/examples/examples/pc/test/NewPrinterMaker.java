...
public class NewPrinterMaker {
   protected static void version() {
      System.err.println("ZeusAgent - NewPrinterMaker version: 1.2.2");
      System.exit(0);
   }

   protected static void usage() {
      System.err.println("Usage: java NewPrinterMaker -s <dns_file> -o <ontology_file> [-gui ViewerProg] [-e <ExternalProg>] [-r ResourceProg] [-name <AgentName>] [-debug] [-h] [-v]");
      System.exit(0);
   }
   ...
   try { 
      ...
      String name = new String ("NewPrinterMaker");
      Bindings b = new Bindings("NewPrinterMaker");
      ...
      for( int j = 0; j < arg.length; j++ ) {
         if ( arg[j].equals("-s") &&  ++j < arg.length )
            ...
            Core.debug = true;
            Core.setDebuggerOutputFile("NewPrinterMaker.log");
         }
