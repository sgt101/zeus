...
public String getDescription() {
	...
	serviceDescription += "<profile:webURL>\" http://"+context.whereAmI() + "/services/AbstractTaskId4\"</profile:webURL>\n";
	...
	serviceDescription += "<profile:restrictedTo rdf:resource=\"http://"+context.whereAmI()+"/ontologies/"+context.getOntologyDb().getOntologyName() +"#PrinterCase#unit_cost#?var37\"/>\n";
	...
	serviceDescription += "<profile:restrictedTo rdf:resource=\"http://"+context.whereAmI()+"/ontologies/"+context.getOntologyDb().getOntologyName() +"#InkCartridge#unit_cost#?var204\"/>\n";
	serviceDescription += "<profile:restrictedTo rdf:resource=\"http://"+context.whereAmI()+"/ontologies/"+context.getOntologyDb().getOntologyName() +"#InkCartridge#number#(10 * ?printer.number)\"/>\n";
	serviceDescription += "</profile:ParameterDescription>\n";
	serviceDescription += "</profile:input>\n";
	...
	serviceDescription += "<profile:restrictedTo rdf:resource=\"http://"+context.whereAmI()+"/ontologies/"+context.getOntologyDb().getOntologyName() +"#Printer#unit_cost#?var41\"/>\n";
	serviceDescription += "<profile:restrictedTo rdf:resource=\"http://"+context.whereAmI()+"/ontologies/"+context.getOntologyDb().getOntologyName() +"#Printer#type#inkjet\"/>\n";
	serviceDescription += "<profile:restrictedTo rdf:resource=\"http://"+context.whereAmI()+"/ontologies/"+context.getOntologyDb().getOntologyName() +"#Printer#number#?var296\"/>\n";
	serviceDescription += "</profile:ParameterDescription>\n";
	serviceDescription += "</profile:postcondition>\n";
