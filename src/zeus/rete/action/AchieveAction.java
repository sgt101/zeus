...
/** 
    ...
    @since 1.1
    */
public class  AchieveAction extends ReteAction {
    ...
    public void executeAction (Action a, Info info) { 
              ...
              System.out.println(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>"); 
              System.out.println(" Tim : right class in use!"); 
              System.out.println(" Schedule time now = " + now); 
      
              int et = (int)(now + ((PrimitiveNumericFn)end_time).intValue());
              double ct = now + ((PrimitiveNumericFn)confirm_time).doubleValue();
              System.out.println("End Time set to : " + et); 
              System.out.println("Confirm Time set to: " + ct); 
              System.out.println(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>"); 
