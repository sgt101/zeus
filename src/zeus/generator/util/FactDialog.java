...
public class FactDialog extends JDialog implements ActionListener {
  protected FactTreeUI     treeView; 
  protected JButton        okBtn, cancelBtn;
  protected FactSelector   caller = null;

  public FactDialog(Frame parent, OntologyDb ontologyDb) {
    super(parent,"Select Fact");
    ...
    treeView = new FactTreeUI(ontologyDb);
