...
public class AgentChangeEvent extends java.util.EventObject {
  ...
  public AgentChangeEvent(Object source, AgentDescription agent, int mode) {
     super(source);
     this.agent = agent;
     this.mode = mode;
     Core.ERROR(mode == ADD || mode == MODIFY || mode == DELETE, 1, this);
  }
  public AgentDescription getAgent()     { return agent; }
