...
public class ProtocolEvent extends Event {
   ...
   public ProtocolEvent(Object source, ProtocolInfo object, long event_mask) {
      super(source, object,PROTOCOL_FIRST,PROTOCOL_LAST,event_mask);
   }
   public ProtocolInfo getProtocolInfo() { return (ProtocolInfo)object; }
}
