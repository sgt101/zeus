...
public class SingleSelectionDialog extends JDialog
  ...
  public SingleSelectionDialog(Frame parent, String title, Object[] data) {
    this(parent,title);
    list.setListData(data);
  }

  public SingleSelectionDialog(Frame parent, String title,
  ...
  public static void main(String arg[]) {
    ...
    SingleSelectionDialog m = new SingleSelectionDialog(f,"Select Servers");
